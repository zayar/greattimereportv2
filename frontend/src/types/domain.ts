...
export type AiRevenueActionSource =
  | "bigquery"
  | "apicore"
  | "firestore"
  | "service_reminder"
...
export type AiRevenueActionType =
...
export type AiRevenueActionStatus =
  | "new"
  | "draft_ready"
  | "pending_approval"
  | "approved"
...
export type AiRevenueWorkflowState =
  | "new"
  | "assigned"
  | "contacted"
  | "scheduled_follow_up"
...
export type AiRevenueVisibilityState =
  | "active"
  | "scheduled"
  | "completed"
  | "suppressed"
...
export type AiRevenueAttributionType =
  | "exact_booking"
...
export type AiRevenueSuppressionScope = "customer" | "service" | "phone_only" | "channel" | "opportunity_type";

export type AiRevenueContactChannel = "phone" | "viber_manual" | "viber_auto" | "in_person" | "other";

export type AiRevenueContactResult =
  | "no_answer"
  | "call_later"
  | "message_sent"
  | "customer_replied"
...
export type AiRevenueOutcomeType =
  | "appointment_booked"
  | "customer_came"
  | "treatment_completed"
...
export type AiRevenueFollowUpChannel = "phone_call" | "manual_viber" | "in_person" | "other";

export type AiRevenueFollowUpResult =
  | "no_answer"
  | "call_later"
  | "interested"
  | "appointment_booked"
...
export type AiRevenueFollowUpScheduleOption =
  | "tomorrow"
  | "three_days"
  | "one_week"
  | "next_month"
...
export type AiRevenueFollowUpStatus = "open" | "completed" | "suppressed";
...
export interface AiRevenueActionsResponse {
